...
(function(jQuery) {
    jQuery.fn.timetabs = function(options) {
        ...
        jQuery.timetabs.defaults, options);
        return this.each(function() {
            ...
            if ((isNaN(opt.interval)) !== true || parseInt(opt.interval) > 0) {
                jQuery(gDLI().t).mouseover(_0).mouseenter(_0).mouseleave(_2);
                jQuery(gDLI().c).mouseover(_0).mouseenter(_0).mouseleave(_2)
            }
            function _4() {
            ...
            function _2() {
                if (opt.continueOnMouseLeave === true) {
                    ...
                    jQuery(gDLI().t).unbind('mouseover', _0).unbind('mouseenter', _0).unbind('mouseleave', _2);
                    jQuery(gDLI().c).unbind('mouseover', _0).unbind('mouseenter', _0).unbind('mouseleave', _2)
                }
            }
            function _3(el, e) {
                clearTimeout(jQuery.timetabs.gDLI[gDLIndex].timeOut);
                ...
                case 'slide':
                    if (gDLI().selfObj.children('dd.active').length == 0) {
                        ...
                        gDLI().selfObj.children('dd.active').slideUp(opt.animationSpeed,
                        function() {
                            tabAnimation(index);
                            jQuery(gDLI().c.get(index)).slideDown(opt.animationSpeed,
                            function() {
                                _1(e);
                ...
                case 'curtain':
                    tabAnimation(index);
                    jQuery(gDLI().c.get(index)).css('z-index', '10000').slideDown(opt.animationSpeed,
                    function() {
                ...
                case 'fade':
                    tabAnimation(index);
                    jQuery(gDLI().c.get(index)).css('z-index', '10000').fadeIn(opt.animationSpeed,
                    function() {
                        gDLI().selfObj.children('dd.active').removeClass('active').hide();
                        _1(e);
                        jQuery(this).css('z-index', '1').addClass('active')
